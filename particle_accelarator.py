...
c_sprite_sheet_image= pygame.image.load('characters/DRAGON_norun.png').convert_alpha()
c_sprite_sheet_image_2= pygame.image.load('characters/DRAGON_norun.png').convert_alpha()
